        ...
        if (response.ok) {
            ...
            response.text().then(text => {
                ...
                try {
                    ...
                    console.error('Error parsing STT locales:', e)
                    sttLocales = 'en-US' // Fallback to a default locale if parsing fails
                }
...
function handleUserQuery(userQuery) {
    ...
    if (socket !== undefined) {
        ...
        socket.emit('message', { clientId: clientId, path: 'api.chat', userQuery: userQuery })
    ...
    speechRecognizer.recognized = async (s, e) => {
        if (e.result.reason === SpeechSDK.ResultReason.RecognizedSpeech) {
            ...
            */
            ...
            chatHistoryTextArea.innerHTML += userName + ': ' + userQuery + '\n\n'
            chatHistoryTextArea.scrollTop = chatHistoryTextArea.scrollHeight
        ...
        document.getElementById('userMessageBox').addEventListener('keyup', (e) => {
            if (e.key === 'Enter') {
                ...
                if (userQuery !== '') {
                    ...
                    chatHistoryTextArea.innerHTML += userName + ': ' + userQuery.trim('\n') + '\n\n'
                    chatHistoryTextArea.scrollTop = chatHistoryTextArea.scrollHeight
